...
<html>
	<head>
		<title>Skyline Rentals</title>	<!-- Title of the site -->
	...
	<header>	
		...
		<ul class="menu1"> <!-- navigation links. -->
        ...
        <a href="userprofile.php"><button class="loginbuttn">Profile</button></a> <!-- Button to access the user profile. -->
		<hr id="bot"><br>
		<ul class="menu2"> <!-- navigation links. -->
	...
	<main>
		<div class="container"> <!-- vehicles slideshow. -->
			<div class="wrapper">
		...
		<div class="boxcover" >
			<div class="box1" >  
				...
				<h2><button class="button1" type="button" id="btn1" onclick="loadData('btn1')">Current Deals</button></h2> <!-- java scripted button -->
			</div>

			<div class="box2">
				<img src="Images/travel plan.jpg">
				<h2><button class="button2" type="button" id="btn2" onclick="loadData('btn2')">Travel Planning</button></h2> <!-- java scripted button -->
			</div>

			<div class="box3">
				<img src="Images/programms.png">
				<h2><button class="button3" type="button" id="btn3" onclick="loadData('btn3')">Services</button></h2> <!-- java scripted button -->
			</div>
		</div>
